			...
			if transportTimer < transportTime
			{
				...
				else
				{
					...
					if global.keyLeft && !global.keyRight
					{
						...
						if object_is_ancestor(target.object_index, prtPlayer)
						{			
							//global.xaccel = -transportSpd - global.xspeed;
							//if global.xaccel <= -transportAcc
							//	global.xaccel = -transportAcc;
						...
						else
						{
							if _move
							{
								//target.xaccel = -transportSpd - target.xspeed;
							...
							//if target.xaccel <= -transportAcc && target.xspeed > -transportSpd
							//	target.xaccel = -transportAcc;
						}
					...
					else if global.keyRight && !global.keyLeft
					{
						...
						{	
							...
							//if _move || global.xspeed >= transportSpd
							//{
							//	if _move
							//	{
							//		global.xaccel = transportSpd - global.xspeed;
							...
							//			global.xaccel = transportAcc;
							//	}
							//	else if global.xspeed >= transportSpd
							//	{
							//		global.xaccel = transportSpd - global.xspeed;
							//	}
							//	//if global.xspeed < transportSpd
					...
					else
					{
						if object_is_ancestor(target.object_index, prtPlayer)
						{
							//global.xaccel = 0 - global.xspeed;
							//if global.xspeed > 0 && global.xaccel <= -transportDec
							//	global.xaccel = -transportDec;
							//else if global.xspeed < 0 && global.xaccel >= transportDec
							//	global.xaccel = transportDec;
							if global.xspeed < 0
							{
						...
						{
							//target.xaccel = 0 - target.xspeed;
							//if target.xspeed > 0 && target.xaccel <= -transportDec
							//	target.xaccel = -transportDec;
							//else if target.xspeed < 0 && target.xaccel >= transportDec
							//	target.xaccel = transportDec;
							if target.xspeed < 0
							{
					...
					if global.keyUp && !global.keyDown
					{
						...
						if object_is_ancestor(target.object_index, prtPlayer)
						{
							//global.yaccel = -transportSpd - global.yspeed;
							//if global.yaccel <= -transportAcc
							//	global.yaccel = -transportAcc;
					...
					else
					{
						...
						if object_is_ancestor(target.object_index, prtPlayer)
						{
							var _move = false;
							with target
								if place_free(x, y+1) || global.yspeed <= 0
									_move = true;
									
							//global.yaccel = fallSpd - global.yspeed;
							//if global.yaccel >= transportDec
							//	global.yaccel = transportDec;
						...
						else
						{
							var _move = false;
							with target
								if place_free(x, y+1) || target.yspeed <= 0
									_move = true;
					...
					if _shouldJump
					{
						if (!prtPlayer.locked && !prtPlayer.showReady && !prtPlayer.teleporting && !prtPlayer.landing) global.hasJumped = true;
						transportTimer = transportTime;
						carrying = false;
						tired = false;
						if object_is_ancestor(target.object_index, prtPlayer)
