...
if canOpen {
    ...
    if instance_exists(prtPlayer) {
        ...
        //for it to activate.
        if (collision_rectangle(x+7, y, x+8, y+sprite_height, prtPlayer, false, false) && dir == -1)
        || (collision_rectangle(x+sprite_width-8, y, x+sprite_width-7, y+sprite_height, prtPlayer, false, false) && dir == 1) {
            canOpen = false;
            opening = true;
