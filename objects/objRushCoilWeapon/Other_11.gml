...
if instance_number(objRushCoil) < 1 {
	...
	if newSystem {
		...
		attackID = instance_create(prtPlayer.x+prtPlayer.image_xscale*26, prtPlayer.y + airIncrease, objRushCoil);
		...
		///OLD SYSTEM: functions more like MM9 and 10. Rush will not land if there isn't a spot available directly in front of MM.
		while !(!position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY-1 + airIncrease, objSolid) && !position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY-1 + airIncrease, objBossDoorH) && !position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY-1 + airIncrease, prtMovingPlatformSolid)
	    ...
	    && (position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, objSolid) || position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, objBossDoorH) || position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, prtMovingPlatformSolid)
		...
		&& !(position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)+tpY, objBossDoorH) && tpY > sprite_get_height(prtPlayer.mask_index)/2)
		...
		|| position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)+tpY, objBossDoorH)
	    ...
	    || position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)+tpY, prtMovingPlatformJumpthrough) {
			...
			else if position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)+tpY, objBossDoorH) {
	            var solidID = instance_position(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)+tpY, objBossDoorH);
	            attackID = instance_create(prtPlayer.x+prtPlayer.image_xscale*26, solidID.y-16, objRushCoil);
	            attackID.shouldLand = true;
	            attackID.image_xscale =prtPlayer.image_xscale;
	        }
		...
		&& !position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY-1 + airIncrease, objBossDoorH)
	    ...
	    || position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, objTopSolid) || position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, prtMovingPlatformJumpthrough)) {
			...
			else if position_meeting(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, objBossDoorH) {
	            var solidID = instance_position(prtPlayer.x+prtPlayer.image_xscale*26, sprite_get_ycenter_object(prtPlayer)-tpY + airIncrease, objBossDoorH);
	            attackID = instance_create(prtPlayer.x+prtPlayer.image_xscale*26, solidID.y-16, objRushCoil);
	            attackID.shouldLand = true;
	            attackID.image_xscale = prtPlayer.image_xscale;
	        }
