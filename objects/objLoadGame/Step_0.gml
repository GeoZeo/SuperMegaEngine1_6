...
if !global.frozen {
	...
	if global.keyUpPressed || global.keyDownPressed {
		if !surePhase && !errorPhase && !successPhase {
			row = 1 - row;
			cursorTimer = row;
			playSFX(sfxMenuMove);
...
if instance_exists(objAchievementBox) alarm[0]++;
