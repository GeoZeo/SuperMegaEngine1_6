/// @description block_base_convert(input, base_from, base_to, block_size_from, block_size_to)
function block_base_convert(argument0, argument1, argument2, argument3, argument4) {
	var input = argument0;
