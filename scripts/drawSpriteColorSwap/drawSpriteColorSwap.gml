/// @description  drawSpriteColorSwap(spr, subimg, sx, sy, src_col1, src_col2, src_col3, col1, col2, col3)
/// Draw sprite replacing colors
function drawSpriteColorSwap(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
