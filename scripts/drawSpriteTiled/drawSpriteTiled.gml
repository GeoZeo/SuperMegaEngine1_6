/// @description drawSpriteTiled(tile width, tile height, top sprite tile, middle sprite tile, bottom sprite tile)
function drawSpriteTiled(argument0, argument1, argument2, argument3, argument4) {
