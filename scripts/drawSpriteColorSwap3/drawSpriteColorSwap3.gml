/// @description  drawSpriteColorSwap3(spr, subimg, sx, sy, src_col1, src_col2, src_col3, col1, col2, col3)
/// Draw sprite replacing three colors
function drawSpriteColorSwap3(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
